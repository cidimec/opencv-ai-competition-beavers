...
stepSize = 0.05
print("---------------------CORRIENDO: distanceFinal.py----------------------")
    ...
    def run(self):
        ...
        while True:
            ...
            for raw_bbox, depth, min_dist in zip(self.bboxes, self.depth_dist, self.min_dists):
                ...
                cv2.putText(self.debug_frame, str(depth[0]), (bbox[0] + 10, bbox[1] + 20),
                            cv2.FONT_HERSHEY_TRIPLEX, 0.5, (255, 255, 10))
                cv2.putText(self.debug_frame, str(depth[1]), (bbox[0] + 10, bbox[1] + 35),
                            cv2.FONT_HERSHEY_TRIPLEX, 0.5, (255, 255, 10))
                cv2.putText(self.debug_frame, str(depth[2]), (bbox[0] + 10, bbox[1] + 50),
                            cv2.FONT_HERSHEY_TRIPLEX, 0.5, (255, 255, 10))
                cv2.putText(self.debug_frame, str(min_dist), (bbox[0] + 10, bbox[1] + 65),
                            cv2.FONT_HERSHEY_TRIPLEX, 0.5, (255, 255, 10))
